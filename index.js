...
//const app = express();
//Cfonts.say('YudaMods',{font: 'tiny'})
//app.get('/', (req, res) => {
//  res.setHeader('Content-Type', 'application/json');
//  const data = {
 //   status: 'true',
//    message: 'YudaMods is now running',
//    author: 'Cyber team'
//  };
...
console.log(chalk.white.bold(`####################################
      ${chalk.yellow.bold("YudaMods")}         
        VER 4.0
    MADE BY ${chalk.yellow.bold("LEXIC TEAM")}
 
✅ WhatsApp: ${chalk.blue.underline("wa.me/6283842204546")}
👥 Github: ${chalk.blue.underline("https://github.com/YUDAMODS")}
